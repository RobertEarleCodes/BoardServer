...
app.listen(PORT, HOST, () => {
  ...
  console.log('🏠 Board Management Server - LAN Only');
  console.log('='.repeat(70));
  
  console.log(`🖥️  Server running on: ${HOST}:${PORT}`);
  console.log('');
  ...
  console.log('');
  console.log('🔒 Security: Local network access only');
  console.log('📋 Available endpoints:');
  console.log('   • / - Board Management Interface');
  console.log('   • /api/current-board - Current Board Data');  
  console.log('   • /api/routes - Route Management');
  console.log('   • /api/zones - Zone Management');
  console.log('='.repeat(70));
